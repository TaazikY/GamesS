...
#include "GameSportsCar.h"
#include "GameSportsWheelFront.h"
#include "GameSportsWheelRear.h"
...
AGameSportsCar::AGameSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UGameSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UGameSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UGameSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UGameSportsWheelRear::StaticClass();
