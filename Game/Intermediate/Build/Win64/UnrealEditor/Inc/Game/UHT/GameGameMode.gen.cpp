...
struct Z_CompiledInDeferFile_FID_Game_Source_Game_GameGameMode_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AGameGameMode, AGameGameMode::StaticClass, TEXT("AGameGameMode"), &Z_Registration_Info_UClass_AGameGameMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGameGameMode), 4163425354U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Game_Source_Game_GameGameMode_h_179951288(TEXT("/Script/Game"),
